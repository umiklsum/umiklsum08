                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <button href="<?= base_url('menu/menuedit/') . $m['id'] ?>" class="btn btn-success btn-sm" data-toggle="modal" data-target="#editMenu<?= $m['id'] ?>">Edit</button>
                                <button onclick="hapusMenu('<?= base_url('menu/hapus/') . $m['id'] ?>')" class="btn btn-danger btn-sm">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
