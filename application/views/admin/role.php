                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button href="#" class="badge badge-success" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#roledit<?= $r['id']; ?>">edit</button>
                                <button onclick="hapusRole('<?= base_url('admin/hapusrole/') . $r['id'] ?>')" class="btn btn-danger btn-sm">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
